...
public class UsersListingWidget extends AbstractModelChangeAwareWidget {
	...
	class CellRenderer implements ITableCellRenderer<User> {
		
		@Override
		public void renderCell(int rowIndex, final int cellIndex, final User rowData, Column column,
	...
	public class Operator extends DataListingOperator<User, InMemoryListHandler<User>> {
