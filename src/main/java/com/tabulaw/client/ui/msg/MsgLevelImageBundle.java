...
public interface MsgLevelImageBundle extends ClientBundle {
	 ...
	 */
	@Source(value = "com/tabulaw/public/images/info.gif")
	ImageResource info();
	 ...
	 * @return the image prototype
	 */
	@Source(value = "com/tabulaw/public/images/warn.gif")
	ImageResource warn();
	 ...
	 * @return the image prototype
	 */
	@Source(value = "com/tabulaw/public/images/error.gif")
	ImageResource error();
	 ...
	 * @return the image prototype
	 */
	@Source(value = "com/tabulaw/public/images/fatal.gif")
	ImageResource fatal();
}