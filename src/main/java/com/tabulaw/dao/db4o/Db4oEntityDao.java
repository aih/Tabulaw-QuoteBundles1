...
import com.tabulaw.model.ITimeStampEntity;
...
public class Db4oEntityDao extends Db4oDaoSupport implements IEntityDao {
	...
	@Override
	public <E extends IEntity> void purgeAll(Collection<E> entities) throws EntityNotFoundException, DataAccessException {
		if(entities != null) {
			for(final E e : entities) {
				purge(e);
			}
