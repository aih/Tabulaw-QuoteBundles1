 ...
 * @author jpk
 */
public class BusinessKeyPropertyException extends Exception {
	 ...
	 */
	public BusinessKeyPropertyException(Class<?> entityClass, String businessKeyName, String businessKeyPropertyName) {
